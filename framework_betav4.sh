...
# Check for Python Web3
    if ! python3 -c "import web3" &> /dev/null; then
        echo "[Missing] Web3.py - Please install it via the setup environment menu."
    else
...
# Check for Solana CLI
    if ! command -v solana &> /dev/null; then
        echo "[Missing] Solana CLI - Please install it via the setup environment menu."
    else
...
# Check for Sugar CLI (Metaplex)
    if ! command -v sugar &> /dev/null; then
        echo "[Missing] Sugar CLI - Please install it via the setup environment menu."
    else
...
# Check for Metaboss CLI
    if ! command -v metaboss &> /dev/null; then
        echo "[Missing] Metaboss CLI - Please install it via the setup environment menu."
    else
...
# Check for Netlify CLI
    if ! command -v netlify &> /dev/null; then
        echo "[Missing] Netlify CLI - Please install it via the setup environment menu."
    else
...
# Check for SPL-Token CLI
    if ! command -v spl-token &> /dev/null; then
        echo "[Missing] SPL-Token CLI - Please install it via the setup environment menu."
    else
...
# Check for Vercel CLI
    if ! command -v vercel &> /dev/null; then
        echo "[Missing] Vercel CLI - Please install it via the setup environment menu."
    else
