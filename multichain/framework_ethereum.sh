...
# =============================
echo "Please select the blockchain environment you are developing for:"
echo "1) Solana"
echo "2) Ethereum"
...
export BLOCKCHAIN_ENV="ethereum"
echo "This script is configured for ethereum. If you need another blockchain, use the corresponding script."
